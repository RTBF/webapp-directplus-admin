...
confDB.once('open', function() {
  ...
  */
  ...
  return Conference.findOne({
    ...
    var slide1, slide10, slide11, slide2, slide3, slide4, slide5, slide6, slide7, slide8, slide9;
    slide1 = new Slide({
    ...
    slide2.save(function(err, slide1) {
      if (err) {
        return console.log("erreur");
      }
    });
    ...
    slide3.save(function(err, slide1) {
      if (err) {
        return console.log("erreur");
      }
    });
    ...
    slide4.save(function(err, slide1) {
      if (err) {
        return console.log("erreur");
      }
    });
    ...
    slide5.save(function(err, slide1) {
      if (err) {
        return console.log("erreur");
      }
    });
    ...
    slide6.save(function(err, slide1) {
      if (err) {
        return console.log("erreur");
      }
    });
    ...
    slide7.save(function(err, slide1) {
      if (err) {
        return console.log("erreur");
      }
    });
    ...
    slide8.save(function(err, slide1) {
      if (err) {
        return console.log("erreur");
      }
    });
    ...
    slide9.save(function(err, slide1) {
      if (err) {
        return console.log("erreur");
      }
    });
    ...
    slide10.save(function(err, slide1) {
      if (err) {
        return console.log("erreur");
      }
    });
    ...
    slide11.save(function(err, slide1) {
      if (err) {
        return console.log("erreur");
      }
    });
