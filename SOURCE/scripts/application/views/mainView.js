...
define(['jquery', 'backbone', 'application/views/organisationView'], function($, Backbone, OrganisationView) {
  ...
  return mainView = (function(_super) {
    ...
    mainView.prototype.save = function() {
      var conference, filled, form, slide, splitString, val;
      form = $('.tab-pane.active > form').serializeArray();
      console.log(form);
      filled = this.checkFill(form);
      if (filled) {
        if ($('.tab-pane.active').attr('id') === 'settings') {
          ...
          if ($('.tab-pane.active').attr('id') === 'video') {
        ...
        return alert('Form must be completely filled');
      }
    };

    mainView.prototype.checkFill = function(form) {
      var input, ok, _i, _len;
