...
define(['application/config', 'jquery', 'application/routes/router', 'application/views/appView', 'application/models/slide', 'application/collections/slides', 'vendors/socketio/socketio'], function(Config, $, Router, AppView) {
  /*
